...
INSERT INTO `__new_credit_card_transaction_installments`("createdAt", "updatedAt", "id", "installmentNumber", "amount", "statementId", "transactionId") SELECT "createdAt", "updatedAt", "id", "installmentNumber", "amount", "statementId", "transactionId" FROM `credit_card_transaction_installments`;--> statement-breakpoint
