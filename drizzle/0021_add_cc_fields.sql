...
INSERT INTO `__new_credit_cards`("createdAt", "updatedAt", "id", "brand", "last4", "expiryMonth", "expiryYear", "accountId") SELECT "createdAt", "updatedAt", "id", "brand", "last4", "expiryMonth", "expiryYear", "accountId" FROM `credit_cards`;--> statement-breakpoint
...
CREATE INDEX `credit_cards_ownerId_idx` ON `credit_cards` (`ownerId`);--> statement-breakpoint
