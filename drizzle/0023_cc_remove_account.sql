...
INSERT INTO `__new_credit_cards`("createdAt", "updatedAt", "id", "brand", "last4", "expiryMonth", "expiryYear", "institution", "ownerId") SELECT "createdAt", "updatedAt", "id", "brand", "last4", "expiryMonth", "expiryYear", "institution", "ownerId" FROM `credit_cards`;--> statement-breakpoint
