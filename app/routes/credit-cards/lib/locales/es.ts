...
export default {
	...
	form: {
		...
		schema: {
			...
			closingDayRequired: 'El día de cierre es requerido',
			closingDayInvalid: 'Debe ser un día válido',
			closingDayRange: 'Debe ser entre 1 y 31',
			dueDayRequired: 'El día de vencimiento es requerido',
