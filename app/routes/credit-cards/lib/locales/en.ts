export default {
	...
	form: {
		...
		schema: {
			...
			closingDayRequired: 'Closing day is required',
			closingDayInvalid: 'Must be a valid day',
			closingDayRange: 'Must be between 1 and 31',
			dueDayRequired: 'Due day is required',
